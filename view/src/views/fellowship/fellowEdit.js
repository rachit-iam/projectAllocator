        ...
        axios({
            ...
            .then((response) => {
                ...
                if (response.data.status === true) {
                    ...
                    this.setState({
                        admn_no: response.data.data.result[0].admn_no,
                    });
                    this.setState({
                        dept_id: response.data.data.result[0].dept_id,
                    });
                    this.setState({
                        course: response.data.data.result[0].course,
                    });
                    this.setState({
                        branch: response.data.data.result[0].branch,
                    });
                    this.setState({
                        from_date: response.data.data.result[0].from_date,
                    });
                    this.setState({
                        to_date: response.data.data.result[0].to_date,
                    });
